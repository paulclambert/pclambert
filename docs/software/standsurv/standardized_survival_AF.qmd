...
Those on hormal treatment will be consided exposed and those **not** taking the treatment will be unexposed, 
...
>            at1(hormon 1) at2(.) atvar(F_hormon1 F_all)      ///    
...
See the page of [The hazard function of the standardized survival curve.]({{< ref "software/standsurv/standardized_survival_hazard.md" >}}) for a description of standardized hazard functions. 
