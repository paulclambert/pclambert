...
- [**stpp**](software/stpp.qmd) - Non-parametric marginal relative (net) survival using Pohar Perme estimator
...
- [**rcsgen**](/software/rcsgen)  - generate restricted cubic splines
