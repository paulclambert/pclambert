...
scalars:
         ...
         e(k_eq_model) =  1
               e(df_m) =  7
               e(chi2) =  408.2254068441378
                  e(p) =  4.10585674068e-84
                e(dev) =  37544.87730353124
                e(AIC) =  37594.87730353124
                e(BIC) =  37769.09675940969

macros:
            e(cmdline) : "i.sex##@ns(agediag,df(3)), scale(lncumhazard) df(5)       tvc(i.sex @ns(agediag,df(3) winsor(1 99))) dftvc(3)       bhazard(rat.."
                e(cmd) : "stpm3"
  ...
  e(ef_agediag_knots1) : "18.12545708589547 71.40992416203093 79.36648884641677 101.5784471531932"
   e(ef_agediag_opts1) : "df(3)"
    ...
    e(sharedtvc_knots) : "1"
        ...
        e(dsplinevars) : "_dns1 _dns2 _dns3 _dns4 _dns5 2.sex#c._dns_tvc1 2.sex#c._dns_tvc2 2.sex#c._dns_tvc3 c._ns_f2_agediag1#c._dns_tvc1 c._ns_f2_aged.."
